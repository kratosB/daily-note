...
## java8默认使用UseParallelGC，是Parallel Scavenge + Parallel Old
## 引用
...
>
> [JVM默认垃圾回收器扫盲，那些说UseParallelGC是 PS + Serial Old 的别再打脸了](https://blog.csdn.net/dandanforgetlove/article/details/106218707)
>
> [Java 8最快的垃圾收集器是什么？](https://www.cnblogs.com/harbin1900/p/8591978.html)